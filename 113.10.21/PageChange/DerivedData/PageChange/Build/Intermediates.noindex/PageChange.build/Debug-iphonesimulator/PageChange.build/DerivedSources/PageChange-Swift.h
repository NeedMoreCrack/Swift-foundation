...
#ifndef PAGECHANGE_SWIFT_H
#define PAGECHANGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PageChange",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PageChange11AppDelegate")
...
SWIFT_CLASS("_TtC10PageChange19FirstViewController")
@interface FirstViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelMessage;
- (IBAction)buttonSecondVC:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC10PageChange19OtherViewController")
@interface OtherViewController : UIViewController
- (IBAction)buttonBack:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10PageChange13SceneDelegate")
...
SWIFT_CLASS("_TtC10PageChange20SecondViewController")
@interface SecondViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelMessage;
- (IBAction)buttonBack:(UIButton * _Nonnull)sender;
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified buttonSwipeBack;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidAppear:(BOOL)animated;
- (void)viewDidLayoutSubviews;
